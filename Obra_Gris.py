...
def validar_formulario_obra_gris(data):
    ...
    campos_calificacion = [
        ...
        ("p5_1_resolucion", "5.1 - Resolución de necesidades"),
        ("p5_2_capacidad", "5.2 - Capacidad cumplimiento"),
        ("p6_1_satisfecho", "6.1 - Satisfacción velocidad"),
        ("p6_2_capacidad", "6.2 - Capacidad respuesta"),
        ("p7_1_integridad", "7.1 - Integridad ética"),
        ("p7_2_humano", "7.2 - Equipo humano"),
        ("p8_1_comprende", "8.1 - Comprende necesidades"),
        ("p8_2_demuestra", "8.2 - Demuestra sensibilidad"),
        ("p9_1_oficinas", "9.1 - Oficinas y espacios"),
        ("p9_2_calidad", "9.2 - Calidad instalaciones"),
        ...
        ("p15_aire", "15 - Aire Acondicionado"),
        ("p15_telefonia", "15 - Telefonía"),
        ("p15_internet", "15 - Internet"),
        ("p15_impresiones", "15 - Impresiones"),
        ("p15_vigilancia", "15 - Vigilancia"),
        ("p16_proceso", "16 - Proceso registro"),
        ("p16_seguridad", "16 - Seguridad"),
        ("p16_areas", "16 - Áreas esparcimiento"),
        ("p16_alquiler", "16 - Alquiler espacios"),
        ("p16_actividades", "16 - Actividades bienestar"),
        ("p16_mantenimiento", "16 - Mantenimiento"),
...
def show_survey_obra_gris():
    ...
    **Te invitamos a participar en esta encuesta.**
    ...
    with st.form("form_obra_gris"):
        ...
        comunicacion_4_1 = st.selectbox("4.1", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_com_4_1", label_visibility="collapsed")
        
        st.markdown("**4.2** ¿Estás satisfecho con el nivel de soporte ofrecido por la zona franca?")
        comunicacion_4_2 = st.selectbox("4.2", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_com_4_2", label_visibility="collapsed")
        ...
        fiabilidad_5_1 = st.selectbox("5.1", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_fia_5_1", label_visibility="collapsed")
        ...
        fiabilidad_5_2 = st.selectbox("5.2", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_fia_5_2", label_visibility="collapsed")
        ...
        capacidad_6_1 = st.selectbox("6.1", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_cap_6_1", label_visibility="collapsed")
        
        st.markdown("**6.2** ¿La capacidad de respuesta ágil de Zonamerica ha influido en la eficiencia operativa de tu empresa?")
        capacidad_6_2 = st.selectbox("6.2", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_cap_6_2", label_visibility="collapsed")
        ...
        confianza_7_1 = st.selectbox("7.1", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_con_7_1", label_visibility="collapsed")
        
        st.markdown("**7.2** ¿El equipo humano de Zonamerica, es amable y diligente e infunde confianza en usted?")
        confianza_7_2 = st.selectbox("7.2", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_con_7_2", label_visibility="collapsed")
        ...
        empatia_8_1 = st.selectbox("8.1", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_emp_8_1", label_visibility="collapsed")
        ...
        empatia_8_2 = st.selectbox("8.2", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_emp_8_2", label_visibility="collapsed")
        ...
        tangibles_9_1 = st.selectbox("9.1", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_tan_9_1", label_visibility="collapsed")
        ...
        tangibles_9_2 = st.selectbox("9.2", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_tan_9_2", label_visibility="collapsed")
        ...
        with col10_1:
            tic_tiempo = st.selectbox("Tiempo de espera", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_tic_tiempo")
        with col10_2:
            tic_calidad = st.selectbox("Calidad de servicio", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_tic_calidad")
        with col10_3:
            tic_atencion = st.selectbox("Atención del personal", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_tic_atencion")
        ...
        with col11_1:
            oper_tiempo = st.selectbox("Tiempo de espera", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_oper_tiempo")
        with col11_2:
            oper_calidad = st.selectbox("Calidad de servicio", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_oper_calidad")
        with col11_3:
            oper_atencion = st.selectbox("Atención del personal", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_oper_atencion")
        ...
        with col12_1:
            com_tiempo = st.selectbox("Tiempo de espera", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_com_tiempo")
        with col12_2:
            com_calidad = st.selectbox("Calidad de servicio", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_com_calidad")
        with col12_3:
            com_atencion = st.selectbox("Atención del personal", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_com_atencion")
        ...
        with col13_1:
            admin_tiempo = st.selectbox("Tiempo de espera", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_admin_tiempo")
        with col13_2:
            admin_calidad = st.selectbox("Calidad de servicio", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_admin_calidad")
        with col13_3:
            admin_atencion = st.selectbox("Atención del personal", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_admin_atencion")
        ...
        with col14_1:
            gci_tiempo = st.selectbox("Tiempo de espera", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_gci_tiempo")
        with col14_2:
            gci_calidad = st.selectbox("Calidad de servicio", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_gci_calidad")
        with col14_3:
            gci_atencion = st.selectbox("Atención del personal", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_gci_atencion")
        ...
        with col15_a:
            sc_limpieza = st.selectbox("Limpieza de su oficina/local", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_sc_limp")
            sc_aire = st.selectbox("Aire Acondicionado", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_sc_aire")
            sc_telefonia = st.selectbox("Servicio de Telefonía", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_sc_tel")
        with col15_b:
            sc_internet = st.selectbox("Servicio de Internet y Datos", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_sc_int")
            sc_impresiones = st.selectbox("Servicios de Impresiones", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_sc_imp")
            sc_vigilancia = st.selectbox("Servicio de vigilancia de su local", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_sc_vig")
        ...
        with col16_a:
            gen_proceso = st.selectbox("Proceso de Registro e Ingreso de Funcionarios, Visitantes y Proveedores", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_gen_proc")
            gen_seguridad = st.selectbox("Seguridad en general", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_gen_seg")
            gen_areas = st.selectbox("Áreas comunes de esparcimiento (internas y externas)", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_gen_areas")
        with col16_b:
            gen_alquiler = st.selectbox("Alquiler de espacios y equipos para actividades de cada usuario/cliente", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_gen_alq")
            gen_actividades = st.selectbox("Actividades promovidas por Zonamerica para el bienestar de la comunidad", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_gen_act")
            gen_mantenimiento = st.selectbox("Mantenimiento y limpieza de la infraestructura de Zonamerica", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_gen_mant")
        ...
        with col17_a:
            pers_restaurante = st.selectbox("Restaurante", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_pers_rest")
            pers_cafe = st.selectbox("Café", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_pers_cafe")
            pers_cajero = st.selectbox("Cajero", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_pers_cajero")
        with col17_b:
            pers_vending = st.selectbox("Vending Machine", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_pers_vend")
            pers_esparcimiento = st.selectbox("Áreas de esparcimiento en general", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_pers_espa")

        st.markdown("---")

        # Pregunta 18: Satisfacción general
        st.markdown("<h4 style='font-size: 20px;'>18. ¿En general, qué tan satisfecho está con Zonamerica? (*)</h4>", unsafe_allow_html=True)
        satisfaccion_general = st.selectbox("Satisfacción general", ["Seleccione el puntaje", 1, 2, 3, 4, 5], index=0, key="og_sat_gen", label_visibility="collapsed")
        ...
        if submitted:
            if aceptacion == "No":
                ...
                campos_faltantes = validar_formulario_obra_gris(data_payload)
